...
let listProviderMonthAvailablity: ListProviderMonthAvailabilityService;

describe('ListProviderMonthAvailablity', () => {
    beforeEach(() => {
        fakeAppointmentsRepository = new FakeAppointmentsRepository();
        listProviderMonthAvailablity = new ListProviderMonthAvailabilityService(
    ...
    it('should be able to list the month availability from provider', async () => {
        ...
        const availability = await listProviderMonthAvailablity.execute({
            provider_id: 'user',
            year: 2021,
            month: 5,
        });
